...
public:
    ...
    explicit ConfirmAddEntityPacket(PacketSequenceIndex AskAddEntityPacketId, Prefab::Type type);
...
public:
    ...
    explicit AddEntityPacket(PacketSequenceIndex AskAddEntityPacketId, Prefab::Type type);
