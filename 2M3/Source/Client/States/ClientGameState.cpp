...
ClientGameState::ClientGameState(StateStack& stack, Context context) :
    State(stack, context),
...
bool ClientGameState::update(sf::Time dt)
{
    gameManager->update(dt);
    return true;
}

bool ClientGameState::handleEvent(const sf::Event& event)
{
    return true;
}
